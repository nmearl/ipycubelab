...
# -*- coding: utf-8 -*-
#
# ipycubelab documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipycubelab', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipycubelabdoc'
...
latex_documents = [
    (master_doc, 'ipycubelab.tex', 'ipycubelab Documentation',
